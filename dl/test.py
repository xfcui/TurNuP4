...
def test_model(model, train_loader, val_loader, test_loader, optimizer, scheduler, num_epochs, device):
    ...
    print_sim_score3(true,best_pred)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resultdir', type=str, default='./kcat/TurNuP4/result/', help='结果保存文件夹位置')
    parser.add_argument('--modeldir', type=str, default='./kcat/TurNuP4/save_model/', help='模型和超参数文件夹位置')
